...
function seedBooks($conn)
{
    ...
    if ($row['total'] == 0) {
        ...
        $sqlInsertBooks = "
            ...
            VALUES
            ('Dom Casmurro', {$autoras['Machado de Assis']}, 'Editora Garnier', 1899, 'Romance', 'static/img/Dom Casmurro1899Romance.jpg', 'Dom Casmurro é um romance clássico de Machado de Assis que trata de amor, ciúme e memória.'),
            ('O Cortiço', {$autoras['Aluísio Azevedo']}, 'Livraria Garnier', 1890, 'Romance', 'static/img/O Cortiço1890Romance.jpg', 'O Cortiço retrata a vida urbana e as tensões sociais do Rio de Janeiro do século XIX.'),
            ('A Hora da Estrela', {$autoras['Clarice Lispector']}, 'Rocco', 1977, 'Ficção', 'static/img/A Hora da Estrela1977Ficção.jpg', 'A Hora da Estrela narra a vida de Macabéa, uma jovem nordestina vivendo no Rio de Janeiro.'),
            ('Memórias Póstumas de Brás Cubas', {$autoras['Machado de Assis']}, 'Garnier', 1881, 'Romance', 'static/img/Memorias Postumas de Bras Cubas1881Romance.jpg', 'O livro apresenta a visão do narrador Brás Cubas após a morte, em tom irônico e crítico.'),
            ('Capitães da Areia', {$autoras['Jorge Amado']}, 'Companhia das Letras', 1937, 'Romance', 'static/img/Capitaes da Areia1937Romance.jpg', 'Conta a vida de um grupo de meninos de rua em Salvador e seus conflitos com a sociedade.'),
            ('Grande Sertão: Veredas', {$autoras['Guimarães Rosa']}, 'Nova Fronteira', 1956, 'Romance', 'static/img/Grande Sertao Veredas1956Romance.jpg', 'Romance modernista que explora a linguagem e a vida no sertão brasileiro.');
        ";
