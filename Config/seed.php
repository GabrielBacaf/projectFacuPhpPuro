...
function seedBooks($conn)
{
    ...
    if ($row['total'] == 0) {
        $sqlInsertBooks = "
            ...
            ('Memórias Póstumas de Brás Cubas', {$autoras['Machado de Assis']}, 'Garnier', 1881, 'Romance', 'static/img/Memórias Póstumas de Brás Cubas1881Romance.jpg', 'O livro apresenta a visão do narrador Brás Cubas após a morte, em tom irônico e crítico.'),
